...
\begin{figure}[]
	\centering
	\subfloat[]{\includegraphics[width=0.32\linewidth]{figures/sts_sample_cloud.png}}
	\subfloat[]{\includegraphics[width=0.32\linewidth]{figures/1_simple.png}}
	\subfloat[]{\includegraphics[width=0.32\linewidth]{figures/255_simple.png}} 
	\centering
	\caption{
		\textbf{(a)} STS-CNN.
...
\begin{figure}[]
	\centering
	\subfloat[]{\includegraphics[width=0.32\linewidth]{figures/sts_sample_multicloud.png}}
	\subfloat[]{\includegraphics[width=0.32\linewidth]{figures/1_multiFake.png}}
	\subfloat[]{\includegraphics[width=0.32\linewidth]{figures/255_multi_fake.png}} 
	\centering
	\caption{
		\textbf{(a)} STS-CNN.
		\textbf{(b)} Modified Model, range $0..1$.
...
\begin{figure}[]
	\centering
	\subfloat[]{\includegraphics[width=0.32\linewidth]{figures/sts_real_cloud.png}}
	\subfloat[]{\includegraphics[width=0.32\linewidth]{figures/1_complex.png}}
	\subfloat[]{\includegraphics[width=0.32\linewidth]{figures/255_complex.png}} 
	\centering
	\caption{
		\textbf{(a)} STS-CNN.
		\textbf{(b)} Modified Model, range $0..1$.
